      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto leading-relaxed" style={{ color: "#64748B" }}>
            Find out exactly what it costs to borrow the amount you need in Canada, from $300 to $5,000.
          </p>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div
                  ...
                  style={{ backgroundColor: "rgba(99, 102, 241, 0.1)" }}
                >
                  <DollarSign className="w-5 h-5 transition-colors duration-300 group-hover:text-white!" style={{ color: "#6366F1" }} />
                </div>
                <ArrowRight
