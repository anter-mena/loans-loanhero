      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="flex flex-col gap-3 text-sm text-slate-400 font-medium items-center md:items-start">
              <li><Link href="/resources/faq" className="transition-colors hover:text-white flex items-center justify-center md:justify-start gap-2 group">FAQ <ArrowRight className="w-3 h-3 opacity-0 translate-x-[-10px] transition-all group-hover:opacity-100 group-hover:translate-x-0" /></Link></li>
              <li><Link href="/blog" className="transition-colors hover:text-white flex items-center justify-center md:justify-start gap-2 group">Blog <ArrowRight className="w-3 h-3 opacity-0 translate-x-[-10px] transition-all group-hover:opacity-100 group-hover:translate-x-0" /></Link></li>
              <li><Link href="/news" className="transition-colors hover:text-white flex items-center justify-center md:justify-start gap-2 group">News <ArrowRight className="w-3 h-3 opacity-0 translate-x-[-10px] transition-all group-hover:opacity-100 group-hover:translate-x-0" /></Link></li>
