...
export const comparisons: ComparisonEntry[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "What credit score do I need for a personal loan instead?", answer: "There's no fixed minimum. LoanHero works with a network of lenders who consider all credit types, including borrowers who might otherwise turn to a payday loan." },
    ],
  },
  {
    ...
    faq: [
      ...
      { question: "Are most LoanHero lender offers secured or unsecured?", answer: "Most personal loans offered through our network are unsecured, meaning you won't need to put up collateral to qualify." },
  ...
  },
  {
    ...
    faq: [
      { question: "What loan terms does LoanHero's network offer?", answer: "Terms typically range from 6 to 72 months, depending on the lender and loan amount." },
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "Will checking rates to compare APR and payment affect my credit?", answer: "No, checking your rate with LoanHero uses a soft credit pull, which doesn't affect your credit score." },
    ],
  },
  {
    ...
    faq: [
      ...
      { question: "How do I know which one LoanHero can match me with?", answer: "Checking your rate shows you offers from our lender network based on your profile, and you can compare the structure and terms of each before choosing." },
    ],
  },
  {
    ...
    optionB: {
      ...
      pros: [
        ...
        "LoanHero operates this way, using a soft credit pull",
    ...
    faq: [
      { question: "Does LoanHero lend money directly?", answer: "No, LoanHero is a comparison service. We match you with offers from a network of lenders, and the lender you choose funds and services the loan." },
      { question: "Does using a comparison service cost anything?", answer: "No, checking your rate and comparing offers through LoanHero is completely free." },
      { question: "Will comparing offers through LoanHero affect my credit score?", answer: "No, we use a soft credit pull to show you offers, which doesn't affect your credit score." },
      { question: "Who do I make my payments to if I accept an offer?", answer: "You'll make payments directly to the lender you're matched with and choose to proceed with, not to LoanHero." },
  ...
  },
  {
    ...
    faq: [
      { question: "Does checking my rate with LoanHero count as prequalification?", answer: "Yes, checking your rate uses a soft credit pull to give you an estimate of what you might qualify for, without affecting your credit score." },
      ...
      { question: "Should I get prequalified with multiple lenders?", answer: "Yes, since prequalification doesn't affect your credit score, comparing estimates from multiple lenders, or one application through LoanHero, is a low-risk way to shop around." },
    ],
  },
  {
    ...
    faq: [
      ...
      { question: "Can a subprime borrower still get approved through LoanHero?", answer: "Yes, we work with a network of lenders who consider all credit types, including borrowers who may fall into the subprime category." },
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "Can LoanHero match me with a credit union offer?", answer: "Our network includes a range of lender types; the specific offers you're matched with depend on your profile and the lenders currently available." },
      ...
      { question: "What if I want to compare both before deciding?", answer: "Checking your rate through LoanHero uses a soft credit pull, so you can compare offers from our network alongside anything your bank or credit union offers directly." },
    ],
  },
  {
  ...
  },
  {
    ...
    faq: [
      { question: "Is LoanHero an online or traditional lender?", answer: "LoanHero isn't a lender at all, we're a free comparison service that matches you with offers from a network of lenders, most of which operate online." },
